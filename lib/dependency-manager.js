...
class DependencyManager {
  ...
  initializeLogger(){
    ...
    if (!providerConfig){
      // LOL - Monkey Patching console because I'm a horrible person.
      // This also let's me us it like an actual dependency.
      console.options = {
        singleton: true
      };
  ...
  getInstance(dependency){
    ...
    switch(mode){
      case 'factory': instance = Provider.create(providerConfiguration, this.getLogger()); break;
